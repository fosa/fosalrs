...
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}[scale=2, domain=0:0.5]
        % Rasterübersicht %%%%%%%
        %   a1  b1  c1  d1  e1  %
        %   a2  b2  c2  d2  e2  %
        %   a3  b3  c3  d3  e3  %
        ...
        \begin{scope}[shift={(a1)}]
            \draw[->] (0,0) -- (0.5,0);
            \draw[->] (0,0) -- (0,0.5);
            \draw[green, thick, samples=200] plot[id=A]
                function{-0.3*exp(-10*x)*(sin(50*x)+cos(50*x))+0.3};
        ...
        \begin{scope}[shift={(b1)}]
            ...
            \draw[->] (0,0) -- (0,0.5);
            \draw[green, thick, samples=200] plot[id=A]
                function{-0.3*exp(-4*x)*(sin(50*x)+cos(50*x))+0.3};
            \node[cross out, draw=black, thick] at (-0.1,-0.1) {};
        \end{scope}
        ...
        \begin{scope}[shift={(d1)}]
            ...
            \draw[->] (0,0) -- (0,0.5);
            \draw[green, thick, samples=200] plot[id=A]
                function{-0.02*exp(5*x)*(sin(50*x)+cos(50*x))+0.02};
            \node[cross out, draw=black, thick] at (-0.1,-0.1) {};
        \end{scope}
        \begin{scope}[shift={(e1)}]
            ...
            \draw[->] (0,0) -- (0,0.5);
            \draw[green, thick, samples=200] plot[id=A]
                function{-0.002*exp(10*x)*(sin(50*x)+cos(50*x))+0.002};
            \node[cross out, draw=black, thick] at (-0.1,-0.1) {};
        \end{scope}
        %
        \begin{scope}[shift={(a2)}]
            \draw[->] (0,0) -- (0.5,0);
            \draw[->] (0,0) -- (0,0.5);
            \draw[red, thick] (0.5,0.5) parabola bend (0.2,0.5) (0,0);
            \node[cross out, draw=black, thick] at (-0.1,-0.1) {};
        \end{scope}
        \begin{scope}[shift={(b2)}]
            \draw[->] (0,0) -- (0.5,0);
            \draw[->] (0,0) -- (0,0.5);
            \draw[red, thick] (0.5,0.5) parabola bend (0.5,0.5) (0,0);
            \node[cross out, draw=black, thick] at (-0.1,-0.1) {};
        \end{scope}
        ...
        \begin{scope}[shift={(d2)}]
            \draw[->] (0,0) -- (0.5,0);
            \draw[->] (0,0) -- (0,0.5);
            \draw[red, thick, samples=200] plot[id=A]
                function{0.0282*(exp(5*x)-1)};
            \node[cross out, draw=black, thick] at (-0.1,-0.1) {};
        \end{scope}
